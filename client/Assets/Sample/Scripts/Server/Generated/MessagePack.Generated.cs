    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        internal static object GetFormatter(global::System.Type t)
        {
            ...
            switch (key)
            {
                ...
                case 1: return new MessagePack.Formatters.Vector3DtoFormatter();
                default: return null;
            }
        }
    }
...
namespace MessagePack.Formatters.Shared.Sample.MessagePack
{
    public sealed class PlayerFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Sample.MessagePack.Player>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Sample.MessagePack.Player value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Vector3Dto>(formatterResolver).Serialize(ref writer, value.Position, options);
        }
        ...
        public global::Shared.Sample.MessagePack.Player Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var __Position__ = default(global::Vector3Dto);
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        __Position__ = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Vector3Dto>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
...
{
    public sealed class Vector3DtoFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Vector3Dto>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Vector3Dto value, global::MessagePack.MessagePackSerializerOptions options)
        {
        ...
        public global::Vector3Dto Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
            ...
            var ____result = new global::Vector3Dto(__X__, __Y__, __Z__);
            reader.Depth--;
            return ____result;
        }
    }
